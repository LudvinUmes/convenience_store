...
let RecetasController = class RecetasController {
    ...
    async buscarPorId(id) {
        return this.recetasService.buscarPorId(id);
    }
    async crear(data) {
        return this.recetasService.crear(data);
    }
    async actualizar(id, data) {
        return this.recetasService.actualizar(id, data);
    }
};
...
], RecetasController.prototype, "listar", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], RecetasController.prototype, "buscarPorId", null);
__decorate([
    (0, common_1.Post)(),

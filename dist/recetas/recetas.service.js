...
let RecetasService = class RecetasService {
    ...
    async listar() {
        return this.prisma.recetas.findMany();
    }
    async buscarPorId(id) {
        return this.prisma.recetas.findUnique({ where: { id } });
    }
    async crear(data) {
        return this.prisma.recetas.create({ data });
    }
    async actualizar(id, data) {
        return this.prisma.recetas.update({ where: { id }, data });
    }
};

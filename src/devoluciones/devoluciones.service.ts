...
import { devoluciones, Prisma } from '@prisma/client';
...
export class DevolucionesService {
     ...
     */
    async crearDevolucion(data: Prisma.devolucionesCreateInput): Promise<devoluciones> {
     ...
     */
    async getDevolucionesByEstado(estado: string): Promise<devoluciones[]> {
     ...
     */
    async getAllDevoluciones(): Promise<devoluciones[]> {
        return this.prisma.devoluciones.findMany({});
    }
     ...
     */
    async getDevolucionById(id: number): Promise<devoluciones> {
     ...
     */
    async updateDevolucion(id: number, data: Prisma.devolucionesUpdateInput): Promise<devoluciones> {
     ...
     */
    async getDevolucionesByVenta(idVenta: number): Promise<devoluciones[]> {
        return this.prisma.devoluciones.findMany({
